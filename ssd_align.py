...
class SSDAligner():
    ...
    def align_and_crop_face(self, image, image_dim):
        """Align and crop single image containing face."""
        ...
        if len(filtered_boxes > 0):
            ...
            cropped = crop(image, largest_box, use_normalized_coordinates=True)

            # Use cv2.INTER_AREA for better downsampling effect
            return resize(cropped, image_dim, interpolation=cv2.INTER_AREA)
        return None
